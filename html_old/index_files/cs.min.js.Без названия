...
init('poll');};if(d.readyState==="complete"||d.readyState==="loaded"||d.readyState==="interactive"){fn.call(g,'lazy');}
else{if(!modern&&de.doScroll){try{top=!g.frameElement;}catch(e){}
if(top)poll();}
...
return ret;},getHitId:function(){return session.hi;},isComagicEnabled:function(){return session.ce;},performCommands:function(commandsList){if(!commandsList||!commandsList.length){return;}
